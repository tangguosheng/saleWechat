...
<body>
	...
	<div class="container bg-white mt5 pd-tb20">
	...
	<div class="index-main bg-white mt5">
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/product?id='.$vo['id']);?>">
				<div class="index-item">
					<div><img src="<?php echo ($vo["pic"]); ?>" class="product" /></div>
