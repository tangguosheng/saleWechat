    	...
    	<ul>
			...
			<li>
				...
				<ul id="product" <?php if(strtolower(CONTROLLER_NAME)== 'product'): ?>style="display:block"<?php endif; ?> >
					<li><a href="<?php echo U('Product/index');?>" data="<?php echo (strtolower(CONTROLLER_NAME)); ?>">商品管理</a></li>
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('cate_edit');?>'">添加分类</button>
			</div><!--tableoptions-->
