...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">自定义CSS样式</h1>
            <span class="pagedesc">自定义的css将会覆盖系统的样式</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				<p>
					<textarea name="content" style=" height:300px; width:100%; border:none; box-sizing:border-box;"><?php echo ($content); ?></textarea>
				</p>
